...
<img src="https://github.com/hyunseungbin9408/CCCR_experience/blob/master/png/Openstack_command_user_check.png" alt="drawing" width="700"/>
...
```
 ...
 마지막으로 source로 접속하고 유저가 전환되어있는지
